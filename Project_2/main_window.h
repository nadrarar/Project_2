...
public:
	...
	GLuint vertex_coordinate_quad_handle;
	GLuint normal_value_handle;
	GLuint texture_coordinate_handle;
	GLuint vertex_array_handle;
	GLuint vertex_array_quad_handle;
