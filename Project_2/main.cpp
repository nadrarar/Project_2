...
void ActiveMouseFunc(int x, int y)
{
	...
	if(mouse_button==GLUT_RIGHT_BUTTON){
		int dx2=x-mouse_x2_prev;
		int dy2=y-mouse_y2_prev;
		...
		window_map[window_handle_map[glutGetWindow()]]->x2 += dx2;
		window_map[window_handle_map[glutGetWindow()]]->y2 += dy2;
...
void PassiveMouseFunc(int x, int y)
{
	...
	window_map[window_handle_map[glutGetWindow()]]->x2 = x;
	window_map[window_handle_map[glutGetWindow()]]->y2 = y;
}
